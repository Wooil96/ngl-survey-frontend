<template>
  <v-container style="width: 50%; padding-top: 5%">
    ...
    <v-card
      ...
      "
    >
      We are developing our own Mobile App. <br />
...
export default {
  ...
  created() {
    this.user.user_email = this.$route.params.user_email;

    this.$http
      .get(`/api/users/${this.user.user_email}`)
      .then((res) => {
    ...
    this.$http
      .get(`api/survey/${this.user.user_email}`)
      .then((res) => {
